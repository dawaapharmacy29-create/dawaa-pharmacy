...
begin
  ...
  where sa.staff_id=p_staff_id::text
  order by coalesce(sa.active,true) desc,sa.created_at desc nulls last limit 1;
  ...
  v_snapshot:=jsonb_build_object(
    'snapshot_schema','payroll_final_snapshot_v2',
  ...
  return v_snapshot||jsonb_build_object('snapshot_fingerprint',md5(v_snapshot::text));
end;
$function$;
