-- Diagnostic summary for the attendance exception inbox.
...
grant execute on function public.attendance_diagnostic_summary_v1(date,date,text) to anon,authenticated,service_role;
