...
-- SECURITY INVOKER is intentional so existing RLS on manager_daily_checklist remains authoritative.
...
is 'Returns cadence-aware completion percentages for manager checklist tasks while respecting table RLS.';
