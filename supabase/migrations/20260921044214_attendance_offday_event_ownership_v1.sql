...
begin
  ...
  where a.staff_id=p_staff_id
    and (
      (v_expected_start is not null and v_expected_end is not null
        and a.recorded_at>=v_window_start and a.recorded_at<v_window_end)
      or
      ((v_expected_start is null or v_expected_end is null)
        and (
          a.shift_date=p_attendance_date
          or (a.shift_date is null and (a.recorded_at at time zone 'Africa/Cairo')::date=p_attendance_date)
        ))
    );
