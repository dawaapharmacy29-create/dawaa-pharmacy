-- Align supporting Customer Service Manager metrics with canonical source semantics.
...
with bounds as (
  ...
  where coalesce((r.conversation_date at time zone 'Africa/Cairo')::date,r.review_date,(r.created_at at time zone 'Africa/Cairo')::date) between b.start_date and b.end_date
  ...
  where w.welcome_message_sent_at is not null
    and (w.welcome_message_sent_at at time zone 'Africa/Cairo')::date between b.start_date and b.end_date
