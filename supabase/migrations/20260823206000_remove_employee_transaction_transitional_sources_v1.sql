...
begin
  ...
  -- No client-side transitional fallbacks remain. Automated settlements are
  -- SECURITY DEFINER functions owned by postgres/BYPASSRLS and do not need a
  -- client RLS exception.
  return false;
end;
$$;
