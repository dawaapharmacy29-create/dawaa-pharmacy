-- Remove the short-lived non-canonical manage_salary_calculator key and keep
-- payroll DB permissions aligned exactly with src/lib/core/permissionSystem.ts.
