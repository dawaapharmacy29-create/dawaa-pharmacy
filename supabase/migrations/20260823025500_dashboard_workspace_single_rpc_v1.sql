...
$$;
revoke all on function public.get_dashboard_workspace_v1(date,date,text) from public;
grant execute on function public.get_dashboard_workspace_v1(date,date,text) to authenticated;
