create or replace function public.calculate_customer_monthly_performance_v3(
  p_branch text,
  p_period_start date,
  p_period_end date,
...
as $function$
  ...
  from public.calculate_customer_monthly_performance_v2(
    p_branch,
    p_period_start,
    least(p_period_end, current_date),
    p_prev_period_start,
    p_prev_period_end
  );
$function$;
revoke all on function public.calculate_customer_monthly_performance_v3(text,date,date,date,date) from public;
grant execute on function public.calculate_customer_monthly_performance_v3(text,date,date,date,date) to authenticated, service_role;
