...
const testFiles = [
  ...
  'src/lib/salesIntelligence/__tests__/invoiceCandidateRetrieval.test.ts',
  ...
  'src/lib/salesIntelligence/__tests__/salesPricingExecutionV1.test.ts',
  ...
  'src/lib/salesIntelligence/pharmacyProducts/__tests__/pharmacyProductResolverV2.test.ts',
  'src/lib/salesIntelligence/__tests__/dashboardScopeV1.test.ts',
  'src/lib/__tests__/productInvoiceVerificationV23.test.ts',
  'src/lib/__tests__/whatsappTruthEngineV2.test.ts',
  'src/lib/__tests__/salesAttributionDraftInvoiceV23.test.ts',
