...

{
  ...
  src = replaceOnce(src, altAnchor, handlers, 'handlers');
  ...
  src = replaceOnce(src, modalAnchor, contactModal + modalAnchor, 'contact modal');
...
console.log('Applied customer request contact results V16 fix');
