...
const CLEAN_UI_FILES = new Set([
  ...
  'src/pages/CustomerDataReview.tsx',
  'src/pages/CustomerServiceCredit.tsx',
  'src/pages/CustomerImport.tsx',
  'src/pages/StaffDuplicateAudit.tsx',
  ...
  'src/pages/Team.tsx',
  'src/pages/ExecutiveDashboardRoute.tsx',
  'src/pages/ExecutiveDashboardSafe.tsx',
  'src/components/common/QuickCustomerCodingModal.tsx',
  'src/components/common/CustomerCodingRequestModal.tsx',
