...
function classifyReason(row: JourneyRow) {
  ...
  if (/فاتورة|invoice/.test(raw) || ((/confirmed|closed|ordered|order/.test(stage)) && row.invoice_match_status !== 'verified')) return 'invoice_missing';
