...
const GROUPS: NavGroup[] = [
  ...
  { title: 'الحضور والوقت', icon: Clock, items: [
    { path: '/attendance-report?tab=dashboard', icon: Activity, label: 'نظرة عامة للحضور', permission: ['view_attendance_leaves','record_attendance'] },
    { path: '/attendance-report?tab=daily', icon: Activity, label: 'متابعة اليوم', allowedRoles: ['general_manager','executive_manager','branches_manager','branch_manager','shift_supervisor_morning','shift_supervisor_evening'] },
