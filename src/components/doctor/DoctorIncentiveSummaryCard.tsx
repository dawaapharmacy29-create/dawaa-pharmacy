...
export default function DoctorIncentiveSummaryCard({
  ...
  // النظام مالوش رصيد ابتدائي ولا سقف أعلى — الحافز بيتراكم من الصفر بس من
  // نشاط حقيقي (محادثات، طلبات، متابعات...). لو مفيش أي مكافآت أو خصومات
  // مسجّلة لسه هذه الدورة، ده معناه إن الدكتور لسه في بداية الدورة فعليًا،
  // فبنوضح ده بدل ما نسيب الصفر يبان زي إنه تقييم سيء.
