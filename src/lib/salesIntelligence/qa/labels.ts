...
export const reviewReasonLabels: Record<string, string> = {
  ...
  invoice_predates_case_start: 'الفاتورة تسبق بداية الحالة زمنيًا ولا يمكن اعتمادها تلقائيًا',
  statistical_invoice_lacks_transactional_corroboration: 'الإسناد الإحصائي يطابق هوية العميل، لكن ينقصه دليل تجاري مستقل أو قرب زمني كافٍ لاعتماده رسميًا',
...
export const ruleIdLabels: Record<string, string> = {
  ...
  'attribution.assessment.no_temporally_valid_candidates': 'كل الفواتير المرشحة المتاحة تتعارض زمنيًا مع بداية الحالة',
