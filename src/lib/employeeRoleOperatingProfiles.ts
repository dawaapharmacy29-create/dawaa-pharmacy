...
const branchManager: EmployeeRoleOperatingProfile = {
  ...
  daily_checklist: checklist('branch_manager', [
    ...
    ['cleanliness', 'تأكيد نظافة الفرع', 'راجع الكاونتر والأرضية والأرفف ومنطقة العملاء.', 'normal', '/branch-checklist-review'],
  ]),
...
const assistant: EmployeeRoleOperatingProfile = {
  ...
  daily_checklist: checklist('assistant', [
    ...
    ['counter_clean', 'تأكيد نظافة الكاونتر', 'راجع نظافة الكاونتر ومنطقة العملاء.', 'normal', '/my-daily-checklist'],
...
const cleaning: EmployeeRoleOperatingProfile = {
  ...
  daily_checklist: checklist('cleaning', [
    ['morning', 'Checklist صباحي', 'نفذ قائمة النظافة الصباحية.', 'high', '/my-daily-checklist'],
    ['evening', 'Checklist مسائي', 'نفذ قائمة النظافة المسائية.', 'high', '/my-daily-checklist'],
    ['floor', 'تأكيد نظافة الأرضية', 'راجع الأرضية ومنطقة العملاء.', 'normal', '/my-daily-checklist'],
    ['counter', 'تأكيد نظافة الكاونتر', 'راجع الكاونتر والأرفف.', 'normal', '/my-daily-checklist'],
    ['note', 'تسجيل أي ملاحظة', 'سجل أي تلف أو احتياج تنظيف.', 'normal', '/my-daily-checklist'],
  ]),
