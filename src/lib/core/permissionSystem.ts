...
export const ROLE_MAP: Record<string, RoleKey> = {
  ...
  'مسئول شيفت صباحي': 'shift_supervisor_morning',
  'مسئولة شيفت صباحي': 'shift_supervisor_morning',
  'مسؤول شيفت صباحي': 'shift_supervisor_morning',
  'مسؤولة شيفت صباحي': 'shift_supervisor_morning',
  'مشرف شيفت مسائي': 'shift_supervisor_evening',
  'مسئول شيفت مسائي': 'shift_supervisor_evening',
  'مسئولة شيفت مسائي': 'shift_supervisor_evening',
  'مسؤول شيفت مسائي': 'shift_supervisor_evening',
  'مسؤولة شيفت مسائي': 'shift_supervisor_evening',
  'صيدلاني': 'pharmacist',
  'صيدلي': 'pharmacist',
  'دكتور': 'pharmacist',
  'د/': 'pharmacist',
  ...
  'مساعد صيدلاني': 'assistant',
  'مساعدة صيدلي': 'assistant',
  'مساعدة صيدلانية': 'assistant',
...
export function hasPermission(
  roleOrUser:
    | string
    | { role?: string | null; permissions?: Record<string, boolean> | null }
    | null
    | undefined,
  permission: string
): boolean {
...
const LEGACY_ALIASES: Record<string, string[]> = {
  ...
  view_attendance_leaves: ['view_attendance_leaves', 'view_leaves', 'manage_leaves', 'attendance_leaves'],
  view_leaves: ['view_attendance_leaves'],
...
export const ROUTE_PERMISSION_MAP: Record<string, string | string[]> = {
  ...
  '/customers/import': ['view_customer_360', 'import_customers'],
  ...
  '/customer-welcome': 'customer_welcome_messages_view',
  ...
  '/whatsapp-customer-history': 'view_reviews',
  '/whatsapp-lost-opportunities': 'view_reviews',
  '/whatsapp-branch-comparison': 'view_reviews',
  '/team': 'view_team',
  '/staff': 'view_team',
  '/staff/:id': 'view_staff_details',
  '/schedule': 'view_schedule',
  '/time-off': ['view_attendance_leaves'],
  '/my-attendance': 'view_dashboard',
  ...
  '/employee-operating-system': 'employee_operating_system_view',
  ...
  '/purchase-returns': 'view_purchases',
  '/purchase-cycle-report': 'view_purchases',
  '/supplier-accounts': 'view_purchases',
  '/purchase-order-log': 'view_purchases',
  '/shift-handovers': 'view_purchases',
  '/staff-payroll': 'manage_payroll',
  '/incentive-governance': 'manage_incentives',
  ...
  '/purchase-invoice-accuracy': 'view_dashboard',
  '/purchase-invoice-entry': 'view_dashboard',
  '/purchase-invoice-review': 'view_team',
