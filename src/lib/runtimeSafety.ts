  ...
  const prototypes: Array<{ proto: object; name: string; fn: () => string }> = [
    {
      ...
      name: 'trim',
      fn: function trimObject(this: unknown) {
        return safeString(this).trim();
      },
    },
    {
      proto: Number.prototype,
      name: 'trim',
      fn: function trimNumber(this: unknown) {
        return safeString(this).trim();
      },
    },
    {
      ...
      name: 'trim',
      fn: function trimBoolean(this: unknown) {
        return safeString(this).trim();
      },
    },
    {
      ...
      name: 'trim',
      fn: function trimArray(this: unknown) {
        return safeString(this).trim();
      },
    },
    {
      proto: Object.prototype,
      name: 'toLowerCase',
      fn: function lowerObject(this: unknown) {
        return safeString(this).toLowerCase();
      },
    },
    {
      proto: Number.prototype,
      name: 'toLowerCase',
      fn: function lowerNumber(this: unknown) {
        return safeString(this).toLowerCase();
      },
    },
    {
      proto: Boolean.prototype,
      name: 'toLowerCase',
      fn: function lowerBoolean(this: unknown) {
        return safeString(this).toLowerCase();
      },
    },
    {
      proto: Array.prototype,
      name: 'toLowerCase',
      fn: function lowerArray(this: unknown) {
        return safeString(this).toLowerCase();
      },
    },
  ];
