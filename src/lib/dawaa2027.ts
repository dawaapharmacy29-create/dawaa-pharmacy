...
} from '@/lib/performance/performanceRulesEngine';
...
export const monthlyPillars2027 = [
  ...
  {
    key: 'stock',
    label: 'المخزون والرواكد واللستة',
    points: 70,
  ...
  {
    key: 'system',
    label: 'استخدام السيستم والتطوير',
    points: 40,
...
export const quarterlyPillars2027 = [
  {
    key: 'sales_growth',
    label: 'إجمالي المبيعات ونموها',
    points: 25,
    description: 'مبيعات الربع مقارنة بالربع السابق ومتوسط الفرع والفريق.',
  },
  {
    key: 'avg_invoice',
    label: 'متوسط الفاتورة',
    points: 20,
    description: 'رفع قيمة الفاتورة باحتراف وبدون شكاوى أو ضغط زائد.',
  },
  {
    key: 'customer_value',
    label: 'العملاء المتكررون والمهمون',
    points: 20,
    description: 'قيمة عملاء الدكتور، الاحتفاظ بالعميل، والعملاء العائدون بعد المتابعة.',
  },
  {
    key: 'list_targets',
    label: 'أدوية اللستة',
    points: 15,
    description: 'تحقيق تارجت الأصناف المخصصة للدكتور مع تسجيل عميل وفاتورة.',
  },
  {
    key: 'stagnant_stock',
    label: 'الرواكد والمخزون',
    points: 10,
    description: 'تحريك الرواكد وقرب الانتهاء بدون شكاوى وببيانات صحيحة.',
  },
  {
    key: 'data_quality',
    label: 'جودة التسجيل وخدمة العميل',
    points: 10,
    description: 'تصنيفات العملاء، الملاحظات، بيانات الهاتف والكود، ونتائج المتابعة.',
  },
];
...
export const defaultEvaluationRules2027 = [
  {
    ...
    title: 'عدم متابعة عميل VIP في موعده',
    points: 25,
    repeatable: true,
    severity: 'medium',
  },
  {
    type: 'penalty',
    category: 'خدمة العملاء',
    title: 'شكوى عميل بسبب أسلوب التعامل',
    points: 40,
    repeatable: true,
    severity: 'high',
  },
  {
    type: 'penalty',
    category: 'خدمة العملاء',
    title: 'فقد عميل مهم بسبب عدم المتابعة',
    points: 60,
    repeatable: true,
    severity: 'high',
  },
  {
    type: 'penalty',
    category: 'التشغيل',
    title: 'تأخير عن الشيفت بدون إذن',
    points: 20,
    repeatable: true,
    severity: 'medium',
  },
  ...
  },
  {
    type: 'penalty',
    category: 'المخزون',
    title: 'صرف راكد بدون تسجيل عميل وفاتورة',
    points: 20,
    repeatable: true,
    severity: 'medium',
  },
  {
    type: 'penalty',
    category: 'أدوية اللستة',
    title: 'تسجيل صنف لستة بدون بيانات العميل',
    points: 15,
    repeatable: true,
    severity: 'medium',
  },
  {
    type: 'penalty',
    category: 'السلامة الدوائية',
    title: 'خطأ دوائي مؤثر أو ترشيح غير مناسب',
    points: 100,
    repeatable: true,
    severity: 'critical',
  },
  {
    type: 'reward',
    category: 'خدمة العملاء',
    title: 'إعادة عميل مهم للشراء بعد متابعة ناجحة',
    points: 20,
    repeatable: false,
    severity: 'positive',
  },
  {
    type: 'reward',
    category: 'التطوير',
    title: 'اقتراح تحسين تم تطبيقه داخل المنظومة',
    points: 30,
    repeatable: false,
    severity: 'positive',
  },
  {
    type: 'reward',
    category: 'المخزون',
    title: 'تحقيق راكد صعب قبل انتهاء الصلاحية',
    points: 20,
    repeatable: false,
    severity: 'positive',
  },
...
export function getInvoiceDuplicateKey(row: Record<string, unknown>) {
  const branch =
    String(pickFirst(row, ['branch', 'branch_name'], 'غير محدد') || 'غير محدد').trim() ||
    'غير محدد';
  const invoiceDate = String(pickFirst(row, ['invoice_date', 'sale_date', 'date'], '')).slice(
    0,
    10
  );
...
export function getInvoiceDate(row: Record<string, unknown>) {
  return String(
    pickFirst(row, ['invoice_date', 'sale_date', 'date', 'created_at', 'transaction_date'], '')
  );
}
...
export function quarterlyIncentiveFromScore(score: number) {
  ...
  return Math.round(
    calculateQuarterlyIncentive({ approvedQuarterlyDeductions: deduction }).quarterlyFinalValue
  );
}
