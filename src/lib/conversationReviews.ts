...
export function baseDoctorImpactFromScore(score: number) {
  // هيكلة نهائية (21 أغسطس 2026) — الهدف: حافز حقيقي للتميّز مش بس تجنّب عقاب.
  // المشكلة في السلم القديم (5/0/-3/-5): 90% كانت بتاخد صفر بالظبط —
  // "منطقة ميتة" بتقتل حافز التحسين عند أداء كويس فعلاً. السلم الجديد بيديها
  // مكافأة إيجابية واضحة، ويفرّق بوضوح بين "تحت المستوى" (-3) و"مشكلة حقيقية" (-10).
  //   100%      ممتازة  -> +5 (أقصى مكافأة، فرق واضح عن مجرد "كويس")
  //   90-99%    كويسة   -> +2
  //   80-89%    ضعيفة   -> -3
  //   <80%      خطيرة   -> -10
  // ملحوظة: اتعمل تراجع لسلم 5/0/-3/-5 من حساب GitHub مباشرة (خارج الشات ده)
  // في 21 أغسطس الساعة 18:48، وتم التأكيد من صاحب الحساب إنه مش هو وإن السلم
  // ده (5/2/-3/-10) هو النهائي المعتمد — استُرجع في 22 أغسطس.
